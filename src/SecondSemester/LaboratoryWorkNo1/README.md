...
| Седжвика         | <h3>Формула для h<sub>k</sub>:</h3>

<p>
  Если <i>k</i> четное:
  <br>
  <code>h<sub>k</sub> = 9 × 2<sup>k</sup> − 9 × 2<sup>k/2</sup> + 1</code>
</p>

<p>
  Если <i>k</i> нечетное:
  <br>
  <code>h<sub>k</sub> = 8 × 2<sup>k</sup> − 6 × 2<sup>(k+1)/2</sup> + 1</code>
</p> | 100 000        | 23.698                | 2 694 474   | 1 463 577   |
